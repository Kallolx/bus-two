  ...
  return (
    <div className="min-h-screen bg-red-600">
      ...
      <div className="fixed top-20 left-0 right-0 bottom-0 overflow-y-auto">
        <ContentWrapper className="min-h-full flex items-start justify-center pt-6 pb-12">
            ...
            {showVerification ? (
              <div className="text-center">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
                  <p className="text-sm text-blue-800">
                    ...
                    activate your account. After verification, you can log in to
              ...
              <>
                <div className="mb-8 text-center">
                  ...
                  <h2 className="text-4xl tracking-tighter font-bold text-gray-900 mb-2">
                    Get Started
                  </h2>
                  <p className="text-gray-600">
                    Create your food stall account
                  </p>
                </div>
